...
// Define CLI options
var fromOption = new Option<string?>("--from") { Description = "Source database type (e.g., sqlserver, postgres, mysql, oracle)" };
var toOption = new Option<string?>("--to") { Description = "Target database type (e.g., sqlserver, postgres, mysql, oracle)" };
...
namingOption.AcceptOnlyFromAmong("auto", "snake_case", "camelCase", "PascalCase", "lowercase", "UPPERCASE", "preserve");
